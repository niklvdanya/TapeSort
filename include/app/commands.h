...
public:
    ...
    std::string getDescription() const override {
        return "sort <input_file> <output_file> [memory_limit_kb] [config_file] - Sort data from "
...
public:
    ...
    std::string getDescription() const override { return "help - Show this help message"; }
};
